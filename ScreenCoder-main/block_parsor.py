...
Format requirements:
1. For each component, output in format: "component_name: <bbox>x1 y1 x2 y2</bbox>"
2. Coordinates should be absolute pixel values
3. Example:
sidebar: <bbox>0 0 240 1000</bbox>
header: <bbox>0 0 1000 56</bbox>"""
